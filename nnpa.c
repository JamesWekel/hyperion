...
/*          of ieee.c. As this are EXPERIMENTAL zvector instructions, the         */
/*          implementation remains with E6 Zvector instructions.                  */
...
DEF_INST( vector_fp_convert_nnp )
{
    ...
    for ( i=0; i< 8; i++ )
    {
        ...
        /* note: An IEEE-inexact exception is not recognized during   */
