...
#define HHC01960 "Diagnose 0x308 Subcode 5: Invalid IPL parameter block: version=%d, hdr.len=%u, ccw.len=%u"
#define HHC01961 "Diagnose 0x308 Subcode 5: IPL Block is not a CCW type block"
