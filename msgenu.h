...
#define HHC01955 "Diagnose 0x288 Watchdog Timer: %s: %d"
#define HHC01956 "Diagnose 0x288 Watchdog Timer: Error in function %s: %s"
//efine HHC01957 (available)
#define HHC01958 "Diagnose 0x288 Watchdog Timer: %s: %s"
#define HHC01959 "Diagnose 0x288 Watchdog Timer: %s"
